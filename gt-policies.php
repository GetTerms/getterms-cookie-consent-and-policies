...
echo '<h2>' . __('Embed your policies', 'getterms-cookie-consent-and-policies') . '</h2>';
echo '<h4>' . __('Use these shortcodes on your pages to display your policy content', 'getterms-cookie-consent-and-policies') . '</h4>';

echo '<select id="language-selector">';
echo '<option value="">' . __('Select a Language', 'getterms-cookie-consent-and-policies') . '</option>';
...
echo '<thead>';
echo '<tr>';
echo '<th>' . __('Policy', 'getterms-cookie-consent-and-policies') . '</th>';
foreach ($languages as $lang_key => $lang_name) {
