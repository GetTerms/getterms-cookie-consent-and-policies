...
echo '<h2>' . esc_html__('Embed your policies', 'getterms-cookie-consent-and-policies') . '</h2>';
echo '<h4>' . esc_html__('Use these shortcodes on your pages to display your policy content', 'getterms-cookie-consent-and-policies') . '</h4>';

echo '<select id="language-selector">';
echo '<option value="">' . esc_html__('Select a Language', 'getterms-cookie-consent-and-policies') . '</option>';
...
echo '<thead>';
echo '<tr>';
echo '<th>' . esc_html__('Policy', 'getterms-cookie-consent-and-policies') . '</th>';
foreach ($languages as $lang_key => $lang_name) {
